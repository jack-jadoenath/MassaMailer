...
<div class="row">
    ...
    <div class="col-md-6">
        ...
        Hier kan de lijst naam aangepast worden. Ook kunnen hier nieuwe ontvangers toe gevoegd worden, maar ook
        bestaande ontvangers aangepast worden.
    </div>
</div>
    ...
    <form method="post" action="{{route('recipient.store')}}" enctype="multipart/form-data" class="col-md-12">
        ...
        <table>
            ...
            <tbody>
                ...
                <input name="id" type="text" class="form-control" id="id" hidden value="{{ $mailinglist->id }}">
            </tbody>
        </table>
        <br>
        <div class="">
